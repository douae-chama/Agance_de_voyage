...
<body>
  ...
  <div class="main-content">
    <div class="container mt-4 ">
      <a href="ajoutercircuit.php" class="btn btn-primary mb-4 float-end cc">
        +Ajouter Circuit
      </a>
      <h2 class="mb-4">Liste des Circuits</h2>
      <div class="row row-cols-1 row-cols-md-3 g-4">
        <?php
        $Circuit = true;
        include_once("connexion.php");
        $query = "select IdCircuit,Titre,Description,Prix,Duree,DateDepart,image from Circuits";
            ...
            <div class="card h-100 shadow-sm d-flex flex-row" style="height: 150px;">
              ...
              <div style="flex: 1 1 60%; display: flex; flex-direction: column;">
                ...
                <div class="card-body" style="flex: 1 1 auto;">
                  <p class="card-text mb-1"><strong>ID Circuit:</strong> <?php echo htmlspecialchars($ligne["IdCircuit"]); ?></p>
                  ...
                  <p class="card-text mb-0"><strong>DateDepart:</strong> <?php echo htmlspecialchars($ligne["DateDepart"]); ?> </p>
                  <p class="card-text mb-1"><strong>Prix:</strong> <?php echo htmlspecialchars($ligne["Prix"]); ?> dh</p>
                </div>
                <div class="card-footer bg-white border-top-0 d-flex p-2">
                  <a href="modifcircuit.php?ic=<?php echo $ligne["IdCircuit"]; ?>" class="btn btn-success btn-sm me-2 ms-5">Modifier</a>
                  <a href="insertionsupprimercircuit.php?ic=<?php echo $ligne["IdCircuit"]; ?>" onclick="return confirm('Vous confirmez la suppression ?');" class="btn btn-danger btn-sm ">Supprimer</a>
                </div>
