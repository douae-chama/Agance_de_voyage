...
$sql = "SELECT r.IdReservation, r.Nom, r.Prenom, r.telephone, r.Adresse, r.email, r.DateReservation, r.NombrePersonnes, r.prixtotal,r. Statut, c.Titre
        FROM Reservations r
        JOIN Circuits c ON r.IdCircuit = c.IdCircuit
        WHERE r.IdCircuit IS NOT NULL";
...
<head>
    <meta charset="UTF-8">
    <title>Réservations Circuits</title>
...
<body>
    ...
    <div class="main-content">
        <h2>Liste des Réservations de Circuits</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($row['Statut'] === 'Confirmée') : ?>
                                    <a href="traiter_reservation.php?id=<?= $row['IdReservation'] ?>&action=annuler&type=circuit" class="btn btn-danger btn-sm">Annuler</a>
                                <?php else : ?>

                                    <a href="traiter_reservation.php?id=<?= $row['IdReservation'] ?>&action=confirmer&type=circuit" class="btn btn-success btn-sm">Confirmer</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endwhile; ?>
