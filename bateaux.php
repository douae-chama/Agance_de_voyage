...
$bateaux = $connexion->query("SELECT IdBateau,Destination, Compagnie, NumBateau, DateDepart,HeureDepart,DateArrivee, HeureArrivee,PrixCabineInterieure,PrixCabineExterieure,PrixCabineBalcon,PrixSuiteLuxe, image FROM Bateaux")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="fr">
...
<head>
    <meta charset="UTF-8">
    <title>Réservation de Bateaux</title>
...
<style>
    ...
    .background-section::before {
        content: "";
        background-image: url('photo et logo/b1.jpg');
...
<body>
  ...
  <a href="mesreservation.php" title="Mes reservation">
    ...
    <div class="background-section">
        <div class="card2">
            <img src="photo et logo/b2.jpg" alt="Vols">
        </div>
    </div>
    <div class="navbar">
        <div class="logo">
    ...
    <form method="POST" action="searchbateau.php" class="search-form">
        <input type="text" name="search" placeholder="Rechercher un bateau..." required>
