...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $prixUnitaire = $hotel['PrixParNuit']; 
    $prixTotal = $prixUnitaire * $number;
    $query = $connexion->prepare("
        INSERT INTO Reservations (IdClient,IdHotel, Nom, Prenom, Telephone, Email, Adresse,NombrePersonnes, DateReservation,prixtotal)
        VALUES (:id_client,:id_hotel, :nom, :prenom, :telephone, :email, :adresse,:number,NOW(), :prixtotal)
    ");
    ...
    echo "<p><strong>Hotel:</strong> " . htmlspecialchars($hotel['Nom']) . "</p>";
