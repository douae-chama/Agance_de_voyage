...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $prixUnitaire = $voyage['Prix']; 
    $prixTotal = $prixUnitaire * $number;
    $query = $connexion->prepare("
        INSERT INTO Reservations (IdClient,IdVoyage, Nom, Prenom, Telephone, Email, Adresse ,NombrePersonnes, DateReservation , prixtotal)
        VALUES (:id_client,:id_voyage, :nom, :prenom, :telephone, :email, :adresse,:number, NOW(), :prixtotal)
    ");
    ...
    echo "<p><strong>Circuit:</strong> " . htmlspecialchars($voyage['Titre']) . "</p>";
