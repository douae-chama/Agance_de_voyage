...
$sql = "SELECT r.IdReservation, r.Nom, r.Prenom, r.telephone, r.Adresse, r.email, r.DateReservation, r.NombrePersonnes, r.prixtotal,r. Statut, v.Titre 
        FROM Reservations r
        JOIN Voyages v ON r.IdVoyage = v.IdVoyage
        WHERE r.IdVoyage IS NOT NULL";
...
<body>
    ...
    <div class="main-content">
        <h2>Liste des Réservations de Voyages</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($row['Statut'] === 'Confirmée') : ?>
                                    <a href="traiter_reservation.php?id=<?= $row['IdReservation'] ?>&action=annuler&type=voyage" class="btn btn-danger btn-sm">Annuler</a>
                                <?php else : ?>

                                    <a href="traiter_reservation.php?id=<?= $row['IdReservation'] ?>&action=confirmer&type=voyage" class="btn btn-success btn-sm">Confirmer</a>
                                <?php endif; ?>
                            </td>
                            </td>
                        </tr>
