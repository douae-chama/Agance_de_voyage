...
<div class="main-content">
    <div class="form-container">
        ...
        <form action="insertionhotel.php" method="post" enctype="multipart/form-data">
            <label for="nom">Nom de l'hôtel :</label><br>
            <input type="text" id="nom" name="nom" placeholder="Nom de l'hôtel" required><br><br>
            ...
            <textarea id="descriptions" name="descriptions" placeholder="Description"></textarea><br><br>

            <label for="prix">Prix par nuit :</label><br>
            <input type="number" id="prix" name="prix" step="0.01" placeholder="Prix par nuit" required><br><br>
