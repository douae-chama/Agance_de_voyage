...
$sql = "SELECT r.IdReservation, r.Nom, r.Prenom, r.telephone, r.Adresse, r.email, r.DateReservation, r.NombrePersonnes, r.prixtotal,r. Statut, b.Destination
        FROM Reservations r
        JOIN Bateaux b ON r.IdBateau = b.IdBateau
        WHERE r.IdBateau IS NOT NULL";
...
<head>
    <meta charset="UTF-8">
    <title>Réservations Bateaux</title>
...
<div class="main-content">
    <h2>Liste des Réservations de Bateaux</h2>
    <table class="table table-hover table-bordered align-middle text-center">
        ...
        <tbody>
            ...
            <a href="traiter_reservation.php?id=<?= $row['IdReservation'] ?>&action=annuler&type=bateau" class="btn btn-danger btn-sm">Annuler</a>
        <?php else : ?>
            
            <a href="traiter_reservation.php?id=<?= $row['IdReservation'] ?>&action=confirmer&type=bateau" class="btn btn-success btn-sm">Confirmer</a>
        <?php endif; ?>
                        </td>
                    </td>
