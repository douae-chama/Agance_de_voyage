...
<body>
  ...
  <div class="main-content">
    <div class="container mt-4 ">
      <a href="ajouterhotel.php" class="btn btn-primary mb-4 float-end cc">
        +Ajouter Hôtel
      </a>

      <h2 class="mb-4">Liste des Hôtels</h2>
      <div class="row row-cols-1 row-cols-md-3 g-4">

        <?php
        $Hotel = true;
        include_once("connexion.php");
        $query = "SELECT IdHotel, Nom, Adresse, Description, PrixParNuit, image FROM Hotels";
          ...
          <div class="w-100 h-50">
            <div class="card h-100 shadow-sm d-flex flex-row" style="height: 150px;">
              ...
              <div style="flex: 1 1 50%;">
                <img src="photo et logo/<?= htmlspecialchars($ligne['image']) ?>" class="img-fluid h-100" style="object-fit: cover; border-top-left-radius: .25rem; border-bottom-left-radius: .25rem;" alt="Image du hotel">
              </div>
              ...
              <div style="flex: 1 1 60%; display: flex; flex-direction: column;">
                ...
                <div class="card-body" style="flex: 1 1 auto;">
                  <p class="card-text mb-1"><strong>ID Hotel:</strong> <?php echo htmlspecialchars($ligne["IdHotel"]); ?></p>
                  <p class="card-text mb-1"><strong>Nom:</strong> <?php echo htmlspecialchars($ligne["Nom"]); ?></p>
                  <p class="card-text mb-1"><strong>Adresse:</strong> <?php echo htmlspecialchars($ligne["Adresse"]); ?></p>
                  <p class="card-text mb-1"><strong>Description:</strong> <?php echo htmlspecialchars($ligne["Description"]); ?></p>
                  <p class="card-text mb-0"><strong>Prix par nuit:</strong> <?php echo htmlspecialchars($ligne["PrixParNuit"]); ?> dh</p>
                </div>

                <!-- Boutons -->
                <div class="card-footer bg-white border-top-0 d-flex p-2">
                  <a href="modifhotel.php?ih=<?php echo $ligne["IdHotel"]; ?>" class="btn btn-success btn-sm me-2 ms-5">Modifier</a>
                  <a href="insertionsupprimerhotels.php?ih=<?php echo $ligne["IdHotel"]; ?>" onclick="return confirm('Vous confirmez la suppression ?');" class="btn btn-danger btn-sm ">Supprimer</a>
                </div>
