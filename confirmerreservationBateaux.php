...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $connexion->prepare("
        INSERT INTO Reservations (IdClient,IdBateau, Nom, Prenom, Telephone, Email, Adresse,NombrePersonnes,DateReservation,prixtotal)
        VALUES (:id_client,:id_bateau, :nom, :prenom, :telephone, :email, :adresse,:number, NOW(),:prixtotal)
    ");
    ...
    echo "<p><strong>Bateau:</strong> " . htmlspecialchars($bateau['Destination']) . " - " . htmlspecialchars($bateau['Compagnie']) . "</p>";
